...
def convert_to_m3u():
    ...
    if os.path.exists(user_final_file):
        with open(user_final_file, "r", encoding="utf-8") as file:
            m3u_output = '#EXTM3U x-tvg-url="http://live.xn--2os270e.site/e.xml.gz,http://livelive.xn--2os270e.site/all.xml.gz,https://live.fanmingming.cn/e.xml,http://epg.51zmt.top:8000/e.xml.gz" catchup="append" catchup-source="?playseek=${(b)yyyyMMddHHmmss}-${(e)yyyyMMddHHmmss}/e.xml"\n'
            current_group = None
            for line in file:
                ...
                if trimmed_line != "":
                    if "#genre#" in trimmed_line:
                        ...
                        m3u_output += f'#EXTINF:-1 tvg-name="{processed_channel_name}" tvg-logo="https://gitee.com/mo-bai01/live/raw/main/tv/{processed_channel_name}.png"'
                        if current_group:
